...
inline constexpr float SPEED_GROWTH = 0.02f; // Рост скорости мяча за каждый удар (+2%)
inline constexpr float MAX_SPEED_FACTOR = 1.5f;  // Максимальная скорость (во сколько раз от базовой)
